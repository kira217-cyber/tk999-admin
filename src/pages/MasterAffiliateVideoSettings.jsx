// src/pages/MasterAffiliateVideoSettings.jsx
...
export default function MasterAffiliateVideoSettings() {
  ...
  const handleAddOrUpdate = async () => {
    ...
    try {
      if (editIndex !== null) {
        await axios.put(`${API_URL}/api/master-affiliate-video/${editIndex}`, {
          url,
        });
        toast.success("Video URL updated!");
        setEditIndex(null);
      } else {
        await axios.post(`${API_URL}/api/master-affiliate-video`, { url });
  ...
  const handleDelete = async (index) => {
    ...
    try {
      await axios.delete(`${API_URL}/api/master-affiliate-video/${index}`);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-emerald-950/20 to-black p-4 sm:p-6 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-emerald-300/80 text-lg sm:text-xl text-center mb-10">
          Add video URLs for Master Affiliate section (MP4 recommended)
        </p>
